...
n = 50;         % количество точек дискретизации
x1 = linspace(-8, 8, n);
x2 = linspace(-8, 8, n);
...
fM = readfis('firstM_my');        % загрузка нечёткой системы с диска
% getfis(fM);
% showfis(fM);
...
fMg = readfis('firstMg_my_5');       % загрузка нечёткой системы с диска
...
% view(-40,30)
xlabel('x_1');   ylabel('x_2');   zlabel('y');
title('firstMg.fis разница') 
%--------------------------------------------------------------------------
% Построение графика нечёткого отображения Сугено
%---------------------------------------------

fS = readfis('firstS_my');       % загрузка нечёткой системы с диска
